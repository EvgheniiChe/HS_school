...
class StudentHomeworkSolutionNotice extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line("Новый комментарий в домашнем задании по {$this->homeworkSolution->theme}");
    }
